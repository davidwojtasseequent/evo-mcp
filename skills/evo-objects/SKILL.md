---
name: evo-objects
description: "Evo geoscience object schema reference — required/optional parameters for every supported object type (pointset, downhole-collection, triangle-mesh, variogram, grids, etc.)"
---

# Evo Geoscience Object Schema Reference
